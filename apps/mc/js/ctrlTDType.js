...
mcControllers.controller('TDTypeCtrl',['$scope', 'TDTypeSvc', '$modal','$rootScope','$routeParams','$location',
...
mcControllers.controller('mdlTDTypeDetailCtrl',['$rootScope','$scope','TDTypeSvc','$modalInstance','id','typeName','AUTH_EVENTS',function($rootScope,$scope,TDTypeSvc,$modalInstance,id,typeName,AUTH_EVENTS){
...
mcControllers.controller('mdlTDTypeAddCtrl',['$scope','TDTypeSvc','$modalInstance','$timeout','$rootScope','typeName',
...
mcControllers.controller('mdlTDTypeEditCtrl',['$scope','TDTypeSvc','$modalInstance','$timeout','$rootScope','id','typeName',
